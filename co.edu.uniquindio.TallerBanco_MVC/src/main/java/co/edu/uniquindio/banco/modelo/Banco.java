...
public class Banco {
    ...
    private void llenarDatosPrueba(){
        try {
            ...
            agregarUsuario("Catalina", "Unicentro", "156", "catalina@email.com", "156");
            agregarUsuario("Juan Carlos", "Calarcá", "456", "juancarlos@email.com", "456");
            agregarCuentaAhorros("123", 1000000);
            agregarCuentaAhorros("456", 3000000);
